...
```{r pathway, cache=FALSE, message=FALSE}
...
## Table S1: Make Input for GSEA

This is to get the *Table S1*. The result can be obtained from *../result/GSEA_output*, too.
...
################################################################################
# Add the following 3 lines at the begining of GSE13355_exp.gct manually.
#1.2
54675	116
NAME	
################################################################################
write.table(t(as.character(GSE13355label$state)), 
    ...
    row.names=FALSE)
################################################################################
# Add the following 2 lines at the begining of GSE13355.cls manually
116 2 1
#ct Psoriasis
################################################################################
