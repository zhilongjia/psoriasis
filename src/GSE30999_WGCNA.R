...
load("../result/cogena_GSE30999.RData")
...
# data preprocess
GSE30999_GEP <- GSE30999.Explist.filtered$GSE30999$x

datExpr <- t(GSE30999_GEP)
...
names(gene_cluster_info) <- rownames(GSE30999_GEP)
...
heatmapTable(clEnrich_res, maintitle="GSE30999 WGCNA Pathway Analysis")
...
allLLIDs <- match(rownames(GSE30999_GEP), eg_Symbol$symbol)

GOenr = GOenrichmentAnalysis(moduleColors, allLLIDs, nBestP = 10)
tab = GOenr$bestPTerms[[4]]$enrichment

save.image("../result/WGCNA/GSE30999_WGCNA.RData")
